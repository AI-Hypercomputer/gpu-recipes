...
```bash
export VM_NAME="${USER}-g4-trtllm-qwen3-4b"
...
python examples/llm_ptq/hf_ptq.py \
    --pyt_ckpt_path /scratch/models/Qwen3-4B \
    --qformat nvfp4 \
    --export_path /scratch/models/exported_model_qwen3_4b_nvfp4 \
    --trust_remote_code
```
...
model_name="/scratch/models/exported_model_qwen3_4b_nvfp4"
TP_SIZE=1
PP_SIZE=1
EP_SIZE=1
