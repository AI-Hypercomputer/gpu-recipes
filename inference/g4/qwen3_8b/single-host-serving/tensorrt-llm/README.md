...
```bash
export VM_NAME="${USER}-g4-trtllm-qwen3-8b"
...
huggingface-cli download Qwen/Qwen2-8B-Instruct --local-dir /scratch/models/Qwen3-8B

# Quantize the model using NVFP4
python examples/llm_ptq/hf_ptq.py \
    --pyt_ckpt_path /scratch/models/Qwen3-8B \
    --qformat nvfp4 \
    --export_path /scratch/models/exported_model_qwen3_8b_nvfp4 \
    --trust_remote_code
```
...
model_name="/scratch/models/exported_model_qwen3_8b_nvfp4"
TP_SIZE=1
PP_SIZE=1
EP_SIZE=1
...
The benchmark results will be saved to files like `/scratch/output_exported_model_qwen3_8b_nvfp4_isl128_osl128_tp1_pp1_ep1_throughput.txt`.
