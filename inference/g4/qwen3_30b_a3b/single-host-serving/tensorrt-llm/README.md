...
huggingface-cli download Qwen/Qwen2-30B-A3B-Instruct --local-dir /scratch/models/Qwen3-30B-A3B
...
# You can also quantize to FP8 by changing --qformat nvfp8
```
...
The benchmark results will be saved to files like `/scratch/output_exported_model_qwen3_30b_a3b_nvfp4_isl128_osl128_tp8_pp1_ep1_throughput.txt`.
