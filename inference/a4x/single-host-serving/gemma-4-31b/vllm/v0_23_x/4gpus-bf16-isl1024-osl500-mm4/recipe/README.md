# Gemma-4 GEMMA-4-31B BF16 MM4 Recipe (A4X)

This recipe configures and serves the **Gemma-4 GEMMA-4-31B** model in **BF16** precision for the **MM4** workload on a single A4X node (4x GB200 GPUs) using vLLM V1.
...
helm install -f values.yaml \
  ...
  $USER-serving-gemma4-gemma-4-31b-bf16-mm4 \
...
```bash
kubectl exec -it deployment/$USER-serving-gemma4-gemma-4-31b-bf16-mm4 -c serving -- \
  vllm bench serve \
