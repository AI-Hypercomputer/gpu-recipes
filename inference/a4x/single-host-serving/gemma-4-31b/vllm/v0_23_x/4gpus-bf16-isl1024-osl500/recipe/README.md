# Gemma-4 GEMMA-4-31B BF16 TEXT Recipe (A4X)

This recipe configures and serves the **Gemma-4 GEMMA-4-31B** model in **BF16** precision for the **TEXT** workload on a single A4X node (4x GB200 GPUs) using vLLM V1.
