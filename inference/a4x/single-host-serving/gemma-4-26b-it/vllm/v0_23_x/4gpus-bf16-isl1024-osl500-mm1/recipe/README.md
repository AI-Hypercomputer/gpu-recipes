# Gemma-4 GEMMA-4-26B-IT BF16 MM1 Recipe (A4X)

This recipe configures and serves the **Gemma-4 GEMMA-4-26B-IT** model in **BF16** precision for the **MM1** workload on a single A4X node (4x GB200 GPUs) using vLLM V1.
