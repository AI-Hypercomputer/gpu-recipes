# Pretrain Mixtral-8x7B workloads on A3 Mega GKE Node pools
...
- [GPUDirect-TCPXO](https://cloud.google.com/kubernetes-engine/docs/how-to/gpu-bandwidth-gpudirect-tcpx#required-features-capabilities)
   component versions:
    - NCCL Plugin: v1.0.1
    - RxDM sidecar: v1.0.8
- [NVIDIA NeMo NGC container image](https://catalog.ngc.nvidia.com/orgs/nvidia/containers/nemo/tags): 24.05
...
helm install -f values.yaml \
    --set-file nemo_config=$REPO_ROOT/src/frameworks/nemo-configs/mixtral-8x7b-256gpus-bf16.yaml \
...
[NeMo configurations](../../../../src/frameworks/nemo-configs/mixtral-8x7b-256gpus-bf16.yaml)
...
- `hparams.yaml`: the NeMo configuration used by the pretraining script. This includes
   the combined [configuration file](../../../../src/frameworks/nemo-configs/mixtral-8x7b-256gpus-bf16.yaml)
