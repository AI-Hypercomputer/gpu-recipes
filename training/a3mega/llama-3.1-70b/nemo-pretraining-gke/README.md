...
- A cluster with 32 nodes [a3-megagpu-8g](https://cloud.google.com/compute/docs/accelerator-optimized-machines#a3-mega-vms) machines
...
- A GKE cluster with the following setup:
    - An A3 Mega node pool (minimum of 32 nodes, 256 GPUs)
...
helm install -f values.yaml \
    --set-file nemo_config=$REPO_ROOT/src/frameworks/nemo-configs/llama3.1-70b-256gpus-bf16.yaml \
    --set workload.image=${ARTIFACT_REGISTRY}/nemo_workload:24.07 \
    --set workload.gcsBucketForDataCataPath=${GCS_BUCKET} \
    $USER-llama-3-1-70b-256-nemo \
...
[NeMo configurations](../../../../src/frameworks/nemo-configs/llama3.1-70b-256gpus-bf16.yaml)
...
- `hparams.yaml`: the NeMo configuration used by the pretraining script. This includes
   the combined [configuration file](../../../../src/frameworks/nemo-configs/llama3.1-70b-256gpus-bf16.yaml)
...
```bash
helm uninstall $USER-llama-3-1-70b-256-nemo
```
