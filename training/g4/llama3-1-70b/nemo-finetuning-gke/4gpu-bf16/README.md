<!-- mdformat global-off -->
# Pretrain llama3-1-70b workloads on g4_standard_192 GKE Node pools with Nvidia NeMo Framework

This recipe outlines the steps for running a llama3-1-70b pretraining
workload on [g4_standard_192 GKE Node pools](https://cloud.google.com/kubernetes-engine) by using the
...
to create your g4_standard_192 GKE cluster.
...
```bash
cd $RECIPE_ROOT
export WORKLOAD_NAME=$USER-g4-4gpu-llama3-1-70b
...
```
kubectl get pods | grep $USER-g4-4gpu-llama3-1-70b
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-g4-4gpu-llama3-1-70b.
...
For example: `$USER-g4-4gpu-llama3-1-70b-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-g4-4gpu-llama3-1-70b
```