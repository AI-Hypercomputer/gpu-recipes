#!/bin/bash
#SBATCH --job-name=agent-qwen3-235-ubench-gsen
#SBATCH --nodes=32
...
export JOB_NAME=agent-qwen3-235-ubench-gsen
export JOB_IDENTIFIER=agent-qwen3-235-ubench-gsen
