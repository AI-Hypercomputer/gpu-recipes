...
export RECIPE_ROOT=$REPO_ROOT/training/a4x/nemotron4_340b/nemo-gke/nemo2509/64gpus-fp8cs-gbs256/recipe
cd $RECIPE_ROOT
```
...
```
kubectl get pods | grep $USER-a4x-nemotron4-340b-16node
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-nemotron4-340b-16node.
...
For example: `$USER-a4x-nemotron4-340b-16node-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-nemotron4-340b-16node
```