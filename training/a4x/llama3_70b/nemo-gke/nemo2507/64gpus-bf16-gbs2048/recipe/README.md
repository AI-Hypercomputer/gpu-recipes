...
export RECIPE_ROOT=$REPO_ROOT/training/a4x/llama3_70b/nemo-gke/nemo2507/64gpus-bf16-gbs2048/recipe
cd $RECIPE_ROOT
```
...
```
kubectl get pods | grep $USER-a4x-llama3-1-70b-16node
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-llama3-1-70b-16node.
...
For example: `$USER-a4x-llama3-1-70b-16node-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-llama3-1-70b-16node
```