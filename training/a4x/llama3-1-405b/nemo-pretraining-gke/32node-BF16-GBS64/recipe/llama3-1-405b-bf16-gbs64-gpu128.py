...
def recipe(
  ...
  # if hasattr(pretrain.model, "config"):
  #   pretrain.model.config.use_distributed_optimizer = True
  #   pretrain.model.config.sequence_parallel = True
  ...
  # https://github.com/NVIDIA-NeMo/NeMo/blob/90a396a567ebb4e8c1c41e454dc00cb71f911317/nemo/collections/llm/recipes/llama31_405b.py#L237
