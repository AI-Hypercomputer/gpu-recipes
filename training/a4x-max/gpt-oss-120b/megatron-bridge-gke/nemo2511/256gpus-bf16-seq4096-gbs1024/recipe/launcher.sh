...
export NCCL_IB_SPLIT_DATA_ON_QPS=2
...
cd Megatron-Bridge
git checkout r0.2.0
sed -i -e '/moe_a2a_overlap: Optional\[bool\] = False/a \    pp_layout: Optional[str] = None' scripts/performance/utils/utils.py && sed -i -e '/DEEPSEEK_V3_GB300_BASE_CONFIG/,/)/ s/moe_a2a_overlap=False,/moe_a2a_overlap=False,\n    pp_layout="Et*4|(t*4|)*14tmL",/' scripts/performance/configs/deepseek/workload_base_configs.py
