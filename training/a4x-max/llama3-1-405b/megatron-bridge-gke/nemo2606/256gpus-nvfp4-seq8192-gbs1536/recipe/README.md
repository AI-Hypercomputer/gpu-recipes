...
export RECIPE_ROOT=$REPO_ROOT/training/a4x-max/llama3-1-405b/megatron-bridge-gke/nemo2606/256gpus-nvfp4-seq8192-gbs1536/recipe
cd $RECIPE_ROOT
```
...
#### Using 64 node (256 gpus) nvfp4 precision
