...
export RECIPE_ROOT=$REPO_ROOT/training/a4x-max/kimi-k2/megatron-bridge-gke/nemo260401/256gpus-fp8mx-seq4096-gbs4096/recipe
cd $RECIPE_ROOT
```
...
```
kubectl get pods | grep $USER-a4x-max-kimi-k2-64node
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-max-kimi-k2-64node.
...
For example: `$USER-a4x-max-kimi-k2-64node-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-max-kimi-k2-64node
```
