<!-- mdformat global-off -->
# Pretrain qwen3-235b-a22b workloads on a4x-max GKE Node pools with Nvidia Megatron-Bridge Framework
...
export RECIPE_ROOT=$REPO_ROOT/training/a4x-max/qwen3-235b-a22b/megatron-bridge-gke/nemo2602/128gpus-fp8mx-seq4096-gbs1024/recipe
cd $RECIPE_ROOT
```
...
```bash
cd $RECIPE_ROOT
export WORKLOAD_NAME=$USER-a4x-max-qwen3-235b-a22b-128gpus
...
```
kubectl get pods | grep $USER-a4x-max-qwen3-235b-a22b-128gpus
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-max-qwen3-235b-a22b-128gpus.
...
For example: `$USER-a4x-max-qwen3-235b-a22b-128gpus-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-max-qwen3-235b-a22b-128gpus
```
