<!-- mdformat global-off -->
# Pretrain qwen3_235b_a22b workloads on a4x-max GKE Node pools with Nvidia Megatron-Bridge Framework

This recipe outlines the steps for running a qwen3_235b_a22b pretraining
...
export RECIPE_ROOT=$REPO_ROOT/training/a4x-max/qwen3-235b-a22b/megatron-bridge-gke/nemo2602/256gpus-fp8mx-seq4096-gbs2048/recipe
cd $RECIPE_ROOT
```
...
#### Using 256 GPUs fp8_mx precision
...
```
kubectl get pods | grep $USER-a4x-max-qwen3-235b-a22b-256gpus
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-max-qwen3-235b-a22b-256gpus.
...
For example: `$USER-a4x-max-qwen3-235b-a22b-256gpus-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-max-qwen3-235b-a22b-256gpus
```
