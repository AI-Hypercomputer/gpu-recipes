...
export RECIPE_ROOT=$REPO_ROOT/training/a4x-max/qwen3-235b-a22b/megatron-bridge-gke/nemo2604/1024gpus-fp8mx-seq4096-gbs32768/recipe
cd $RECIPE_ROOT
```
...
```bash
cd $RECIPE_ROOT
export WORKLOAD_NAME=$USER-a4x-max-qwen3-235b-a22b-1024gpus
...
```
kubectl get pods | grep $USER-a4x-max-qwen3-235b-a22b-256node
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-max-qwen3-235b-a22b-256node.
...
For example: `$USER-a4x-max-qwen3-235b-a22b-256node-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-max-qwen3-235b-a22b-256node
```
