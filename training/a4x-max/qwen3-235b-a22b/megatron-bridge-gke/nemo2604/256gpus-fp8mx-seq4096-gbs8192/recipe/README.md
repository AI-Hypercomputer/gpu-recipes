...
export RECIPE_ROOT=$REPO_ROOT/training/a4x-max/qwen3-235b-a22b/megatron-bridge-gke/nemo2604/256gpus-fp8mx-seq4096-gbs8192/recipe
cd $RECIPE_ROOT
```
...
```
kubectl get pods | grep $USER-a4x-max-qwen3-235b-a22b-64node
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-max-qwen3-235b-a22b-64node.
...
For example: `$USER-a4x-max-qwen3-235b-a22b-64node-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-max-qwen3-235b-a22b-64node
```
