...
export RECIPE_ROOT=$REPO_ROOT/training/a4high/llama3-1-405b/nemo-pretraining-gke
```
...
helm  install -f values.yaml \
    --set-file nemo_config=$REPO_ROOT/src/frameworks/a4high/nemo-configs/llama3-1-405b-224gpus-a4high-fp8.yaml \
...
cd $RECIPE_ROOT
helm  install -f values.yaml \
    --set-file nemo_config=$REPO_ROOT/src/frameworks/a4high/nemo-configs/llama3-1-405b-224gpus-a4high-bf16.yaml \
    --set workload.image=us-central1-docker.pkg.dev/deeplearning-images/reproducibility/pytorch-gpu-nemo-nccl:nemo25.02-gib1.0.5-A4 \
    --set queue=${KUEUE_NAME} \
    --set volumes.gcsMounts[0].bucketName=${GCS_BUCKET} \
...
[NeMo configurations fp8](../../../../src/frameworks/a4high/nemo-configs/llama3-1-405b-224gpus-a4high-fp8.yaml)
[NeMo configurations bf16](../../../../src/frameworks/a4high/nemo-configs/llama3-1-405b-224gpus-a4high-bf16.yaml)
...
-   `hparams.yaml`: the NeMo configuration used by the pretraining script. This
    ...
    [configuration file](../../../../src/frameworks/a4high/nemo-configs/llama3-1-405b-224gpus-a4high-fp8.yaml)
