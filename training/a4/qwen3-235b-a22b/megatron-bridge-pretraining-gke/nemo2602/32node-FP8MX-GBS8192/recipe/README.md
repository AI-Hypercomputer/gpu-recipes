...
export RECIPE_ROOT=$REPO_ROOT/training/a4/qwen3-235b-a22b/megatron-bridge-pretraining-gke/nemo2602/32node-FP8MX-GBS8192/recipe
cd $RECIPE_ROOT
```
...
```bash
cd $RECIPE_ROOT
export WORKLOAD_NAME=$USER-qwen3-235b-32node-fp8mx-gbs8192
...
```
kubectl get pods | grep $USER-qwen3-235b-32node-fp8mx-gbs8192
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-qwen3-235b-32node-fp8mx-gbs8192.
...
```bash
helm uninstall $USER-qwen3-235b-32node-fp8mx-gbs8192
```