...
helm  install -f values.yaml \
    --set-file nemo_config=$REPO_ROOT/src/frameworks/a4/nemo-configs/llama3-1-70b-256gpus-a4-fp8.yaml \
...
cd $RECIPE_ROOT
helm  install -f values.yaml \
    --set-file nemo_config=$REPO_ROOT/src/frameworks/a4/nemo-configs/llama3-1-70b-256gpus-a4-bf16.yaml \
    --set workload.image=us-central1-docker.pkg.dev/deeplearning-images/reproducibility/pytorch-gpu-nemo-nccl:nemo25.02-gib1.0.5-A4 \
    --set queue=${KUEUE_NAME} \
    --set volumes.gcsMounts[0].bucketName=${GCS_BUCKET} \
...
kubectl get pods | grep $USER-llama-3-1-70b-nemo-bf16
