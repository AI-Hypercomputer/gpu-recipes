<!-- mdformat global-off -->
# Pretrain llama3-1-70b workloads on a4 GKE Node pools with Nvidia NeMo Framework (Intelligence)
...
export RECIPE_ROOT=$REPO_ROOT/training/a4/llama3-1-70b/nemo-pretraining-gke/2node-bf16-seq8192-gbs256
cd $RECIPE_ROOT
```
