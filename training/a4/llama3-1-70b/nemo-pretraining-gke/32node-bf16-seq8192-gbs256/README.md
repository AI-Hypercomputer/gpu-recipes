<!-- mdformat global-off -->
# Pretrain llama3-1-70b workloads on a4 GKE Node pools with Nvidia NeMo Framework
...
export RECIPE_ROOT=$REPO_ROOT/training/a4/llama3-1-70b/nemo-pretraining-gke/32node-bf16-seq8192-gbs256/recipe
cd $RECIPE_ROOT
```
...
```bash
cd $RECIPE_ROOT
export WORKLOAD_NAME=$USER-a4-llama3-1-70b-32node
helm install $WORKLOAD_NAME . -f values.yaml \
--set-file workload_launcher=launcher.sh \
--set-file workload_config=llama3-1-70b-bf16-seq8192-gbs256-gpus256.py \
...
```
kubectl get pods | grep $USER-a4-llama3-1-70b-32node
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4-llama3-1-70b-32node.
...
For example: `$USER-a4-llama3-1-70b-32node-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4-llama3-1-70b-32node
```
