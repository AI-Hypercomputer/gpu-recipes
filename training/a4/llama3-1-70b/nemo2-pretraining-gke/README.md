...
```
gcloud storage cp gs://cloud-samples-data/third-party/pile/*.* gs://${GCS_BUCKET_DATA}/
```
...
export RECIPE_ROOT=$REPO_ROOT/training/a4/llama3-1-70b/nemo2-pretraining-gke
cd $RECIPE_ROOT
```
...
...
```
/usr/local/google/home/amaloo/gpu-recipes/training/a4/llama3-1-70b/nemo2-pretraining-gke/llama3-1-70b.py
- `nemo-configuration.yaml`: the NeMo configuration used by the pretraining script. This includes
   the combined [configuration file](../nemo2-pretraining-gke/llama3-1-70b.py.yaml)
