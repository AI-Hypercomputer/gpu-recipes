...
export RECIPE_ROOT=$(pwd)
cd ${RECIPE_ROOT}
cp ./recipes/llama3-70b-64gpu-tp2-pp4-cp1-vp5-gbs128-mbs1.yaml ./helm_context/selected-configuration.yaml
cp ./recipes/values-llama3-70b-64gpu-tp2-pp4-cp1-vp5-gbs128-mbs1.yaml ./helm_context/values.yaml
