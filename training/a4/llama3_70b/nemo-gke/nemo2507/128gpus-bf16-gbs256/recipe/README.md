...
export RECIPE_ROOT=$REPO_ROOT/training/a4/llama3_70b/nemo-gke/nemo2507/128gpus-bf16-gbs256/recipe
cd $RECIPE_ROOT
```
...
- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4-llama3-1-70b-16node.
...
For example: `$USER-a4-llama3-1-70b-16node-workload-0-0-s9zrv`.
