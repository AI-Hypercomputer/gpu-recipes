...
export RECIPE_ROOT=$REPO_ROOT/training/a3ultra/llama3_70b/megatron-bridge-gke/nemo2602/64gpus-fp8cs-seq8192-gbs256/recipe
cd $RECIPE_ROOT
```
...
#### Using 8 node (64 gpus) fp8cs precision
