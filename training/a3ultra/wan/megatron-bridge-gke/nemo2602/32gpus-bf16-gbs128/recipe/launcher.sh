...
git -C /opt/Megatron-Bridge checkout f7a9428f301fa17ac374d5e7166a63b0aa4771af
...
worker_command=$(cat <<- EOM
  ...
  python examples/megatron/recipes/wan/pretrain_wan.py \
    ...
    --mock \
    --config-file examples/megatron/recipes/wan/conf/h100_perf_pretrain_mock.yaml \
